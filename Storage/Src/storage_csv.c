...
static void Storage_FormatSignedCenti(int32_t raw,
                                      Storage_Fixed2_t *out)
{
    uint32_t magnitude;
    ...
    size_t line_size)
{
    ...
    written = snprintf(
        ...
        (unsigned int)data->gnss_valid,
        (long)data->latitude_e7,
        (long)data->longitude_e7,
        roll.sign,
        (unsigned long)roll.whole,
        (unsigned long)roll.frac,
        pitch.sign,
        (unsigned long)pitch.whole,
        (unsigned long)pitch.frac,
        temperature.sign,
        (unsigned long)temperature.whole,
        (unsigned long)temperature.frac,
        (unsigned long)(data->pressure_hpa100 / 100U),
        (unsigned long)(data->pressure_hpa100 % 100U),
        (unsigned long)(data->humidity_pct100 / 100U),
        (unsigned long)(data->humidity_pct100 % 100U),
        (unsigned long)(data->voltage_mv / 1000U),
        (unsigned long)(data->voltage_mv % 1000U),
        (unsigned int)data->battery_pct);
