...
#define PX4LITE_MAVLINK_SYSTEM_ID        2U
...
/* 电机占空比专用槽：两路交替，每路刷新约 2 * PERIOD，必须明显小于接收端
 * PX4LITE_REMOTE_TELEMETRY_TIMEOUT_MS(3000ms)，否则远程电机字段会周期性过期归零。 */
#define PX4LITE_MAVLINK_REMOTE_MOTOR_PERIOD_MS  500U
/* 远程显示状态槽：模块状态灯/系统就绪/告警摘要三条 NAMED_VALUE 轮转，
 * 每条刷新约 3 * PERIOD，状态灯变化慢，可低速发送。 */
