 ...
 */
#define DEBUG_SELFTEST_ACTIVE_ENABLE   (DEBUG_SELFTEST_ENABLE && (DEBUG_SELFTEST_IMU_SNAPSHOT_ENABLE || DEBUG_SELFTEST_BSP_INIT_ENABLE || DEBUG_SELFTEST_DISPLAY_BUDGET_ENABLE || DEBUG_SELFTEST_REMOTE_VIEW_ENABLE || DEBUG_SELFTEST_GT911_ENABLE))
