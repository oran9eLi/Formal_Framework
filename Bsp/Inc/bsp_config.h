...
#define BSP_LCD_FSMC_CMD_ADDR \
    (BSP_LCD_FSMC_BANK_ADDR | (((1UL << BSP_LCD_FSMC_REG_SEL) - 1UL) << 1))
#define BSP_LCD_FSMC_DAT_ADDR \
    (BSP_LCD_FSMC_BANK_ADDR | ((1UL << BSP_LCD_FSMC_REG_SEL) << 1))
...
#define BSP_LCD_FSMC_GPIO_CLK_ENABLE() do { \
...
#define BSP_TOUCH_GPIO_CLK_ENABLE() do { \
